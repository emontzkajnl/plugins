...
$className = 'ilfb-ag-featured-post-sidebar row';
...
<div class="col-12 m-col-9">
    ...
    <?php if ($fi_primary_key) { echo '<p class="cat-text color__primary"><a href="'.get_category_link( $fi_primary_key).'">'.get_cat_name($fi_primary_key).'</a></p>'; } ?>
            <a href="<?php echo get_the_permalink($featured_image->ID); ?>">
...
<div class="col-12 m-col-3">
    ...
    <?php if ($one_primary_key) { echo '<p class="cat-text color__primary"><a href="'.get_category_link( $one_primary_key).'">'.get_cat_name($one_primary_key).'</a></p>'; } ?>
    <a href="<?php echo get_the_permalink($side_article_one->ID); ?>">
        <h3 class="title-link"><?php echo $side_article_one->post_title; ?></h3>
    </a>

    <a href="<?php echo get_the_permalink($side_article_two->ID); ?>">
        <?php echo get_the_post_thumbnail($side_article_two->ID); ?>
    </a>
    <?php if ($two_primary_key) { echo '<p class="cat-text color__primary"><a href="'.get_category_link( $two_primary_key).'">'.get_cat_name($two_primary_key).'</a></p>'; } ?>
    <a href="<?php echo get_the_permalink($side_article_two->ID); ?>">
        <h3 class="title-link"><?php echo $side_article_two->post_title; ?></h3>
    </a>
</div>
</div>
