...
Plugin URI: https://wordpress.org/extend/plugins/nospamnx/
...
Copyright 2008-2022 Sven Kubiak
			...
			<div class="wrap">
				...
				<div id="poststuff">
					<div class="postbox opened">
						<h3 class="hndle"><label for="title"><?php echo __('Statistic','nospamnx'); ?></label></h3>
						<div class="inside">
							<table>
								<tr>
					...
					<div class="postbox opened">
						<h3 class="hndle"><label for="title"><?php echo __('Operating mode','nospamnx'); ?></label></h3>
						<div class="inside">
					...
					<div class="postbox opened">
						<h3 class="hndle"><label for="title"><?php echo __('Blacklist','nospamnx'); ?></label></h3>
						<div class="inside">
