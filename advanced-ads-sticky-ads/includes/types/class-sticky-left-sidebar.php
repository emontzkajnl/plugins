<?php
/**
 * This class represents the "Sticky Left Sidebar" placement type.
 *
...
/**
 * Type Sticky Left Sidebar.
 */
class Sticky_Left_Sidebar extends Base implements Placement_Type {
	...
	public function get_title(): string {
		return __( 'Left Sidebar', 'advanced-ads-sticky' );
	}
	...
	public function get_description(): string {
		return __( 'Sidebar on the left side of the content wrapper.', 'advanced-ads-sticky' );
	}
	...
	public function get_image(): string {
		return AA_STICKY_ADS_BASE_URL . 'assets/img/sticky-sidebar-left.png';
	}
