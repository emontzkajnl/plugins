<?php
/**
 * This class represents the "Sticky Right Window" placement type.
 *
...
/**
 * Type Sticky Right Bar.
 */
class Sticky_Right_Window extends Base implements Placement_Type {
	...
	public function get_title(): string {
		return __( 'Right Bar', 'advanced-ads-sticky' );
	}
	...
	public function get_description(): string {
		return __( 'Bar on the right side of the window.', 'advanced-ads-sticky' );
	}
	...
	public function get_image(): string {
		return AA_STICKY_ADS_BASE_URL . 'assets/img/sticky-right.png';
	}
