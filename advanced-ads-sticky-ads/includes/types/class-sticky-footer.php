<?php
/**
 * This class represents the "Sticky Footer" placement type.
 *
 ...
 * Type Sticky Footer.
 */
class Sticky_Footer extends Base implements Placement_Type {
	...
	public function get_title(): string {
		return __( 'Footer Bar', 'advanced-ads-sticky' );
	}
	...
	public function get_description(): string {
		return __( 'Fixed footer bar.', 'advanced-ads-sticky' );
	}
	...
	public function get_image(): string {
		return AA_STICKY_ADS_BASE_URL . 'assets/img/sticky-footer.png';
	}
