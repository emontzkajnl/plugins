<?php
/**
 * This class represents the "Sticky Header" placement type.
 *
 ...
 * Type Sticky Header.
 */
class Sticky_Header extends Base implements Placement_Type {
	...
	public function get_title(): string {
		return __( 'Header Bar', 'advanced-ads-sticky' );
	}
	...
	public function get_description(): string {
		return __( 'Fixed header bar.', 'advanced-ads-sticky' );
	}
	...
	public function get_image(): string {
		return AA_STICKY_ADS_BASE_URL . 'assets/img/sticky-header.png';
	}
