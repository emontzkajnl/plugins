...
if ( ! function_exists( 'stmt_get_google_fonts' ) ) {
	function stmt_get_google_fonts() {
		$font_options = array();

		$font_options[''] = __( '--- Select Font Family ---', 'stmt_theme_options' );

		foreach ( stmt_google_fonts_array() as $font_key => $font_data ) {
...
if ( ! function_exists( 'stmt_get_google_font_variants' ) ) {
	function stmt_get_google_font_variants( $font, $variants = array() ) {
		$chosen_variants = array();

		if ( empty( $variants ) ) {

			$stmt_custom_fonts = stmt_get_google_fonts();

			if ( array_key_exists( $font, $stmt_custom_fonts ) ) {
				$variants = $stmt_custom_fonts[ $font ]['variants'];
			}
		}
...
if ( ! function_exists( 'stmt_google_fonts_array' ) ) {
	function stmt_google_fonts_array() {
		...
		$stmtGFonts = array(
			...
			'Poppins'         => array(
				'label'    => 'Poppins',
				'variants' => array( '100','200','200i','300','300i','400','400i','500','600','700','800','900' ),
				'subsets'  => array( 'latin', ),
				'category' => 'serif',
			),
			'Prata'                    => array(
		...
		return apply_filters('stmt_to_google_fonts', $stmtGFonts);
	}
}