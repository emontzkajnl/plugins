...
class MediaUpload extends _element.Component {
  ...
  onOpen() {
    ...
    if (!isGallery) {
      (0, _lodash.castArray)(this.props.value).forEach(id => {
        selection.add(wp.media.attachment(id));
      });
    } // Load the images so they are available in the media modal.


    const attachments = getAttachmentsCollection((0, _lodash.castArray)(this.props.value)); // Once attachments are loaded, set the current selection.
