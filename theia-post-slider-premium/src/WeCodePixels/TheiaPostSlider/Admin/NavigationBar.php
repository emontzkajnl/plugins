	...
	public function echoPage() {
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
                ...
                Templates::getDropdownNavigationHtml($options);
				?>
			</table>
			<br>
		...
		<script type="text/javascript">
			function updateSlider() {
				...
				tpsInstance.setNavText($('#tps_navigation_text').val());

				// Update title text
				tpsInstance.setTitleText($('#tps_helper_text').val());

				// Update button text
				tpsInstance.options.prevText = $('#tps_prev_button_text').val();
				tpsInstance.options.nextText = $('#tps_next_button_text').val();
