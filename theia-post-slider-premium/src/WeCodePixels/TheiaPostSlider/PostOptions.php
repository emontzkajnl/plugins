...
class PostOptions {
    ...
    public static function add_meta_boxes_callback( $post ) {
        ...
        $menu = [
            0  => [ 'id' => 'navigation-bar', 'title' => 'Navigation Bar' ],
            50 => [ 'id' => 'advanced', 'title' => 'Advanced' ],
        ];
        ...
        <div id="theia-post-slider-post-options">
            <div class="nav-tab-wrapper">
                ...
                foreach ( $menu as $menuItem ) {
                    ?>
                    <a href="#<?php echo $menuItem['id']; ?>" class="nav-tab"><?php echo $menuItem['title']; ?></a>
                    <?php
                }
                ?>
            </div>
            <div class="_tab" id="navigation-bar">
                <table class="form-table">
                    ...
                    Templates::getDropdownNavigationHtml( $options, true );
        ...
        foreach ( $options as $optionKey => $option ) {
            if ( ! array_key_exists( $optionKey, $defaults ) ) {
                ...
                if ( is_bool( $defaults[ $optionKey ] ) ) {
                    $options[ $optionKey ] = $option === true || $option === 'true';
                }
            }
        }
    ...
    public static function get_post_defaults() {
        $defaults = array(
            ...
            'dropdown_vertical_position' => 'global',
