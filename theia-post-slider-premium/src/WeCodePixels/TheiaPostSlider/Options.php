...
class Options extends \WeCodePixels\TheiaPostSliderFramework\Options {
     ...
     * @return string
     */
    public static function get_font_icon( $direction, $optionGroups = null ) {
        if ( Options::get( 'theme_vector_custom', $optionGroups ) ) {
            return base64_decode( Options::get( $direction == 'left' ? 'theme_vector_custom_left_icon' : 'theme_vector_custom_right_icon', $optionGroups ) );
        }

        return Options::get( $direction == 'left' ? 'theme_vector_left_icon' : 'theme_vector_right_icon', $optionGroups );
    }
    ...
    protected static function get_defaults() {
        $defaults = array(
            ...
            'tps_general'         => array(
                ...
                'theme_vector_left_icon'         => self::get_svg_for_icon( 'chevron-circle', 'left' ),
                'theme_vector_right_icon'        => self::get_svg_for_icon( 'chevron-circle', 'right' ),
            ...
            'tps_nav'             => array(
                ...
                'dropdown_vertical_position'    => 'none',
