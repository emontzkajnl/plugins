    ...
    public function echoPage()
    {
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label>
                            ...
                            Vector icons
                            <p class="description">
                                <strong><?php echo count($icons) ?></strong> awesome SVG vector icons. Retina-ready. Can be
                                highly customized.
                            </p>
                        </label>
                        <br>
        ...
        <script type="text/javascript">
            function updateSlider() {
                ...
                if (typeof(tpsInstance) != 'undefined') {
                    // Update transition.
                    tpsInstance.setTransition({
                        'effect': $('#tps_transition_effect').val(),
                        'speed': parseInt($('#tps_transition_speed').val())
                    });

                    var custom = document.querySelector('[name*=theme_vector_custom]').checked;
                    var customLeftIcon = $('[name*=theme_vector_custom_left_icon]').val();
                    var customRightIcon = $('[name*=theme_vector_custom_right_icon]').val();

                    // Update buttons.
                    tpsInstance.options.themeType = themeType;
                    tpsInstance.options.prevFontIcon = custom ? atob(customLeftIcon) : selected.leftIcon;
                    tpsInstance.options.nextFontIcon = custom ? atob(customRightIcon) : selected.rightIcon;
                    tpsInstance.updateNavigationBars();
                }
