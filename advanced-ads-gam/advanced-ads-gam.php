...
function advanced_ads_gam_missing_base_plugin() {
	...
	echo '<div class="error"><p>' . wp_kses( __( '<strong>Advanced Ads – Google Ad Manager Integration</strong> is an extension for the free Advanced Ads plugin.', 'advanced-ads-gam' ), [ 'strong' => [] ] ) . '&nbsp;'
		. wp_kses(
			$link,
			[
				'a' => [
