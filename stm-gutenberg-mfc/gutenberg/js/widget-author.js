registerBlockType('stm-gutenberg/widget-author', {
  ...
  edit(props) {
    ...
    return [React.createElement(ServerSideRender, {
      block: "stm-gutenberg/widget-author",
      ...
      title: i18n.__('Author Settings'),
      className: 'stm-categories-settings',
      initialOpen: false
    }, React.createElement(TextControl, {
      type: 'text',
      label: i18n.__('Author img Link'),
      value: authorImg,
      onChange: newImg => props.setAttributes({
        author_img: newImg
      })
    }), React.createElement(TextControl, {
      type: 'text',
      label: i18n.__('Author SubTitle'),
      value: authorSubtitle,
      onChange: newSubtitle => props.setAttributes({
        author_subtitle: newSubtitle
      })
    }), React.createElement(TextControl, {
      type: 'text',
      label: i18n.__('Author Title'),
      value: authorName,
      onChange: newName => props.setAttributes({
        author_name: newName
      })
    }), React.createElement(TextareaControl, {
      type: 'text',
      label: i18n.__('Author Description'),
      value: authorDesc,
      onChange: newDesc => props.setAttributes({
        author_desc: newDesc
      })
    })))];
  },
