registerBlockType('stm-gutenberg/widget-tag-cloud', {
    title: 'STM Widget Tags Cloud',
    ...
    edit (props) {
        ...
        function setState(state) {
            props.setAttributes( {showCount: state} );
        }

        return[
            <ServerSideRender block="stm-gutenberg/widget-tag-cloud" attributes={props.attributes}/>,
