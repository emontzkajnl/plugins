registerBlockType('stm-gutenberg/widget-instagram-feed', {
    title: 'STM Widget Instagram Feed',
    ...
    edit (props) {
        ...
        return[
            <ServerSideRender block="stm-gutenberg/widget-instagram-feed" attributes={props.attributes}/>,
            <BlockControls key="controls">
                <BlockAlignmentToolbar
                    value={ align }
                    onChange={ ( align ) => props.setAttributes( { align: align } ) }
                    controls={ [ 'wide', 'full' ] }
                />
            </BlockControls>,
