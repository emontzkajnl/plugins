registerBlockType('stm-gutenberg/widget-must-read', {
    title: 'STM Widget Must Read',
    ...
    edit (props) {
        ...
        return[
            <ServerSideRender block="stm-gutenberg/widget-must-read" attributes={props.attributes}/>,
            <InspectorControls key="inspector">
                ...
                <PanelBody title={ i18n.__( 'View Settings' ) } className='stm-posts-view-settings' initialOpen={ false }>
                    <SelectControl label={ i18n.__( 'View Style' ) } value={ viewStyle } options={ mustReadStyles } onChange={ (selectedStyle) => props.setAttributes( { viewStyle: selectedStyle } ) }/>
                    <div>CSS Box</div>
