...
registerBlockType('stm-gutenberg/posts-slider', {
    ...
    edit: function (props) {
        ...
        return [
            <ServerSideRender block='stm-gutenberg/posts-slider' attributes={props.attributes} />,
            <InspectorControls key='inspector'>
                ...
                <PanelBody title={ i18n.__( 'View Settings' ) } className="stm-posts-view-settings" initialOpen={ false }>
                    ...
                    <SelectControl label={ i18n.__( 'View Style' ) } value={ viewStyle } options={ viewStylesSlider } onChange={ (selectedStyle) => props.setAttributes( { viewStyle: selectedStyle } ) }/>
                    <div>CSS Box</div>
