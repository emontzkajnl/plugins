registerBlockType('stm-gutenberg/widget-archive', {
    title: 'STM Widget Archive',
    ...
    edit (props) {
        ...
        return[
            <ServerSideRender block="stm-gutenberg/widget-archive" attributes={props.attributes}/>,
            <InspectorControls key="inspector">
                ...
                <PanelBody title={ i18n.__( 'View Settings' ) } className='stm-posts-view-settings' initialOpen={ false }>
                    <SelectControl label={ i18n.__( 'View Style' ) } value={ viewStyle } options={ archiveStyles } onChange={ (selectedStyle) => props.setAttributes( { viewStyle: selectedStyle } ) }/>
                    <div>CSS Box</div>
