...
registerBlockType('stm-gutenberg/video-format-posts-slider', {
    title: 'STM Posts Video Format Slider',
    ...
    edit: function (props) {
        ...
        timeOut = setTimeout(function () {
            var owlVFPS = jQuery('.stmt-v-p-slider-wrap');
        ...
        return [
            <ServerSideRender block="stm-gutenberg/video-format-posts-slider" attributes={ props.attributes }/>,
            <InspectorControls key="inspector">
                ...
                <PanelBody title={ i18n.__( 'View Settings' ) } className="stm-posts-view-settings" initialOpen={ false }>
                    ...
                    <SelectControl label={ i18n.__( 'View Style' ) } value={ viewStyle } options={ viewStylesVideoPostsSlider } onChange={ (selectedStyle) => props.setAttributes( { viewStyle: selectedStyle } ) }/>
