...
const createWithMetaAttributeSource = metaAttributes => createHigherOrderComponent(BlockEdit => _ref => {
  ...
  return createElement(BlockEdit, _extends({
    ...
    setAttributes: nextAttributes => {
      const nextMeta = mapKeys( // Filter to intersection of keys between the updated
      // attributes and those with an associated meta key.
      pickBy(nextAttributes, (value, key) => metaAttributes[key]), // Rename the keys to the expected meta key name.
